const MESSAGE_PAIRS = Object.freeze({
  "model.label": ["Model for this edit", "本次编辑模型"],
  "model.configuredCount": ["{count} configured", "已配置 {count} 个"],
  "model.configuredList": ["Configured models", "已配置模型"],
  "model.defaultBadge": ["Default", "默认"],
  "model.loading": ["Loading models…", "正在读取模型…"],
  "model.preparing": ["Preparing the models available for this edit.", "正在准备本次可用的编辑模型。"],
  "model.loadingDetail": ["Configured models will appear when loading finishes.", "读取完成后将显示已配置模型。"],
  "model.loadFailed": ["Could not load the model list", "模型列表读取失败"],
  "model.loadFailedDetail": ["Configured models could not be read. Try loading them again.", "未能读取已配置模型，请重新读取。"],
  "model.empty": ["No API models configured", "尚未配置 API 模型"],
  "model.emptyDetail": ["Configure models and rebind the project, then reload the list.", "配置模型并重新绑定项目后，再读取列表。"],
  "model.unconfiguredDetail": ["Configure API models, then reopen the canvas.", "请先配置 API 模型，再重新打开画布。"],
  "model.retry": ["Reload models", "重新读取"],
  "model.searchEmpty": ["No matching models. Try another name.", "没有匹配的模型，请尝试其他名称"],
  "model.default": ["{name} · Default", "{name} · 默认"],
  "model.unavailable": ["Configuration unavailable: {profile}", "配置已不可用：{profile}"],
  "model.select": ["Select a model for this edit", "选择本次编辑模型"],
  "model.choose": ["Choose a model", "选择模型"],
  "model.search": ["Search names, aliases, or providers", "搜索名称、别名或供应商"],
  "model.searchLabel": ["Search models", "搜索模型"],
  "model.noMatch": ["No matching models", "没有匹配的模型"],
  "model.parameters": ["Parameters for this edit", "本次模型参数"],
  "model.localOnly": ["Applies to this edit without changing the default model", "仅用于本次修改，不更改默认模型"],
  "model.changed": ["Model configuration changed; select it again", "此模型配置已改变，请重新选择"],
  "model.missingKey": ["This provider needs an API Key", "此供应商尚未配置 API Key"],
  "model.noEdit": ["Image editing is not enabled for this model", "此模型未启用图片编辑"],
  "model.missing": ["Configure and select an edit model", "请配置并选择编辑模型"],
  "model.chatgpt": ["ChatGPT · This edit", "ChatGPT · 本次修改"],
  "model.json": ["Enter valid JSON", "请输入有效的 JSON"],
  ...
  "auth.route": ["Image generation route", "图片生成路线"],
  "auth.selectRoute": ["Select image generation route", "选择图片生成路线"],
  "auth.apiKeyConfigured": ["API Key configured", "API Key 已配置"],
  ...
  "status.capabilityUnsupported": ["This Codex App does not support the selected submission mode. Check canvas_submission_mode", "当前 Codex App 不支持所选提交方式，请检查 canvas_submission_mode 配置"],
